...
export default function ObjectivesWidget() {
  ...
  return (
    <>
      {plateModal && (
        <div
          className={styles.plateOverlay}
          onClick={() => setPlateModal(false)}
        >
          <div
            className={styles.plateModal}
            onClick={(e) => e.stopPropagation()}
          >
            <div className={styles.plateModalTitle}>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
              ...
              Saisir la plaque d'immatriculation
            </div>
            <div className={styles.plateInputWrapper}>
              <div
                className={`${styles.plateFrame} ${plateError ? styles.plateFrameError : ""}`}
              >
            ...
            <div className={styles.plateModalActions}>
              <button
                className={styles.plateCancel}
                onClick={() => setPlateModal(false)}
              >
                Annuler
              </button>
              <button
                className={styles.plateConfirm}
      ...
      <div className={styles.wrapper}>
        <button
          ...
          onAnimationEnd={(e) => {
            if (e.animationName === "badgePulse") $widgetPulse.set(false);
          }}
        >
